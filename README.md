...
در اجرای اولیه، اولین درخواست Client با `Connection refused` مواجه شد، اما چهار درخواست بعدی موفق شدند. علت این رفتار یک **race condition طبیعی هنگام startup** است: ممکن است Client قبل از آماده شدن کامل HTTP Server اولین درخواست خود را ارسال کند. در اجرای بعدی، هر پنج درخواست با موفقیت پاسخ گرفتند.
